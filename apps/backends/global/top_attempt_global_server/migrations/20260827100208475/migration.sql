...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('top_attempt_global', '20260827100208475', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260827100208475', "timestamp" = now();
...
--
-- MIGRATION VERSION FOR 'top_attempt'
--
DELETE FROM "serverpod_migrations"WHERE "module" IN ('top_attempt');
